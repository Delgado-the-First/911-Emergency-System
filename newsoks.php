                        ...
                        <form method="POST" action="editmodal.php" class="grid grid-cols-2 gap-8 mt-6">
                            <div class="col-span-2 space-y-6">
                                <div class="grid grid-cols-3 gap-6">
                                    ...
                                    <input type="hidden" name="agent_id" value="${agent_id}" readonly disable>
                                    <input type="hidden" name="team" value="${team}" readonly disable>
                                    <input type="hidden" name="service_type" value="${serviceType}"readonly disable>
                                    <input type="hidden" name="call_type" value="${callType}" readonly disable>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Service Type</label>
                                        <select id="service_type" name="service_type" class="w-full mt-1 rounded-lg border border-gray-300 p-2 bg-transparent" required>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Call Type</label>
                                        <select id="call_type" name="call_type" class="w-full mt-1 rounded-lg border border-gray-300 p-2 bg-transparent" required>
