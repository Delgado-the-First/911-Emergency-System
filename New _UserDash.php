                                        ...
                                        <table class="is-zebra w-full text-left" id="callLogTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="whitespace-nowrap bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="display: none;">Agent ID</th>
