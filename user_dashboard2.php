    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
            ...
            <div class="main-sidebar">
                <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
                    ...
                    <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                        ...
                        <!-- Reports -->
                        <a href="user_dashboard3.php" class="flex size-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Reports'">
                                        ...
                                        <form class="grid grid-cols-2 gap-8 mt-6" method="post" action="process_add_log.php">
                                            <div class="col-span-2 space-y-6">
                                                ...
                                                <div class="grid grid-cols-3 gap-6">
                                                    ...
                                                    <!-- Call Date -->
                                                    <div>
                                                        <label for="callDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                                            Call Date
                                                        </label>
                                                        <input id="callDate" name="callDate"
                                                            type="text"
                                                            class="w-full mt-1 rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                    ...
                                                    <div class="flex items-center gap-6">
                                                        ...
                                                        <div >
                                                            ...
                                                            >
                                                                ...
                                                                <option value="closed_case">Case Closed</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <textarea id="remarks" name="remarks" rows="4" class="w-full rounded-md form-textarea w-full rounded-lg border border-slate-300 bg-transparent p-2.5 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                                                    placeholder="Enter Reamrks"></textarea>
                                                </div>
                                            </div>
                                            <!-- Submit Button -->
                                        ...
                                        <table class="w-full text-left" id="callLogTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="whitespace-nowrap rounded-r-lg bg-slate-200 px-3 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="display: none;">Reason of Call</th>
                                                    <th class="whitespace-nowrap rounded-r-lg bg-slate-200 px-3 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="display: none;">Actions Taken</th>
                                                    <th class="whitespace-nowrap rounded-r-lg bg-slate-200 px-3 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="display: none;">Remarks</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <!-- PHP Content -->
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    ...
                                                                    echo "<tr class='hover:bg-slate-100 clickable-row $rowClass' $opacityStyle
                                                                            ...
                                                                            <td style='display: none;' class='whitespace-nowrap px-4 py-3 sm:px-5'>{$row['reason_of_call']}</td>
                                                                            <td style='display: none;' class='whitespace-nowrap px-4 py-3 sm:px-5'>{$row['actions_taken']}</td>
                                                                            <td style='display: none;' class='whitespace-nowrap px-4 py-3 sm:px-5'>{$row['remarks']}</td> 
        ...
        <div id="x-teleport-target"></div>
            <script>
                    ...
                    if (action === 'view') {
                                    ...
                                    <div class="col-span-2 space-y-6">
                                        <div class="grid grid-cols-3 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="service_type" value="${serviceType}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Call Type</label>
                                                <input type="text" name="call_type" value="${callType}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Location</label>
                                                <input type="text" name="location" value="${location}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-3 gap-6">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="call_date" value="${callDate}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Call Time</label>
                                                <input type="text" name="call_time" value="${callTime}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-3 gap-6">
                                            <div class="col-span-2">
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Name</label>
                                                <input type="text" name="name" value="${name}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                            </div>
                                            <div class="flex items-center gap-6">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Age</label>
                                                    <input type="text" name="age" value="${age}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Status</label>
                                                    <input type="text" name="status" value="${status}" class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                        ...
                        modalBody.innerHTML = `
                            ...
                            <div class="flex justify-end space-x-4 mt-4">
                                <button onclick="deleteCase(${id})" class="btn bg-error font-medium text-white hover:bg-error-focus hover:shadow-lg hover:shadow-error/50 focus:bg-error-focus focus:shadow-lg focus:shadow-error/50 active:bg-error-focus/90">Yes</button>
                ...
                // Sa Date na dae nag wowork punyeta!
                document.addEventListener("DOMContentLoaded", () => {
                    console.log("Script is running");

                    // Select the input field
                    const callDateInput = document.getElementById('callDate');
                    console.log("Input field:", callDateInput);
